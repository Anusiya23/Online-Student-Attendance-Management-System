        ...
        <form method="POST" action="">
            <div class="form-grid">
                ...
                <div>
                    ...
                    <select name="subject_papercode" id="subject_papercode" required>
                        <option value="">Select Paper Code</option>
                        <?php
                        $subject_query = $conn->query("SELECT DISTINCT subject_papercode FROM subjects");
                        while ($subject_row = $subject_query->fetch_assoc()) {
                            $selected = (isset($_POST['subject_papercode']) && $_POST['subject_papercode'] === $subject_row['subject_papercode']) ? 'selected' : '';
                            echo "<option value='{$subject_row['subject_papercode']}'>{$subject_row['subject_papercode']}</option>";
                        } ?>
                    </select>
